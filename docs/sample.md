...
<template>
  ...
  <div class="relative">
    ...
    <div v-if="btn_visibility" class="margintop050 flex flexend">
      <button @focus="btnFucos" id="obj-btn" :tabindex="get_btn_index()" :disabled="btn_is_disabled" :style="get_button_style" @click="submit" class="dq-button borderRad4">
